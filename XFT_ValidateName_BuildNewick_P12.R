...
Trait = data.frame(XFTdata$rowID,XFTdata$Cleaned.binomial, XFTdata$Developmental.stage, XFTdata$Plant.organ, XFTdata$Curve, XFTdata$P12..MPa.,XFTdata$P12..MPa.,XFTdata$P88..MPa.)
Trait$XFTdata.P12..MPa. = as.numeric(Trait$XFTdata.P12..MPa.)
...
Trait = Trait[which(!is.nan(Trait$XFTdata.P12..MPa.)),]
Trait = Trait[which(!is.nan(Trait$XFTdata.Cleaned.binomial)),]
Trait = Trait[which(Trait$XFTdata.P12..MPa. <= -0.25),]
Out = data.frame(Trait$XFTdata.rowID,Trait$XFTdata.Cleaned.binomial,Trait$XFTdata.P12..MPa.,Trait$XFTdata.rowID,Trait$XFTdata.rowID)
...
#4. Write Newick Tree
write.tree(phylotree$scenario.3,paste(inpath,"TRY_Values_NewickTrees/XFT_P12_Newick.txt",sep=""))
...
write.table(TraitExport,paste(inpath,"TRY_Values_NewickTrees/XFT_P12_Values.csv",sep=""),row.names = FALSE,sep=",",quote = FALSE)
