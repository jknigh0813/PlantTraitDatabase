...
#4. Write Newick Tree
write.tree(phylotree$scenario.3,paste(inpath,"TRY_Values_NewickTrees/TRY_P50_Newick.txt",sep=""))
...
write.table(TraitExport,paste(inpath,"TRY_Values_NewickTrees/TRY_P50_Values.csv",sep=""),row.names = FALSE,sep=",",quote = FALSE)
